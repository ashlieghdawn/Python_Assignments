...
def load_gui(self):
    ...
    self.lbl_header = ttk.Label(self.master, bg='lightgrey', font=('Roboto',18,'bold'), text='Transfer Recently Modified Files')
    ...
    self.lbl_transfer_from = ttk.Label(self.master, bg='lightgrey', font=('Roboto',12), text='Transfer from:')
    self.lbl_transfer_from.grid(row=1, column=0, columnspan=2, padx=(25,0), pady=(10,0), sticky=N+W)
    self.lbl_transfer_to = ttk.Label(self.master, bg='lightgrey', font=('Roboto',12), text='Transfer to:')
    ...
    self.btn_browse_from = ttk.Button(self.master, width=10, height=1, bg='slategrey', text='Browse', command=lambda: fileMoverGuifunc.browse_folder_from(self))
    self.btn_browse_from.grid(row=2, column=4, padx=(25, 0), pady=(7, 0), sticky=N+W)
    self.btn_browse_to = ttk.Button(self.master, width=10, height=1, bg='slategrey', text='Browse',command=lambda: fileMoverGuifunc.browse_folder_to(self))
    ...
    self.btn_run = ttk.Button(self.master,width=8, height=2, bg='slategrey', text='Run', command=lambda: fileMoverGuifunc.run_file_transfer(self))
